...
from app.models.core import Base, ApprovalPolicy  # Import ApprovalPolicy for migrations
...
from app.models.namaste import Visit, Accommodation, Transport, ItineraryItem  # Import namaste models
